        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDiscountApply = table.Column<bool>(type: "bit", nullable: false),
                    DiscountPriceType = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PercentageValue = table.Column<int>(type: "int", nullable: true),
                    FixedValue = table.Column<double>(type: "float", nullable: true),
                    CreatedDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<int>(type: "int", nullable: true),
                    ModificationDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ModificationBy = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServicesEmployees", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ServicesEmployees_Employee_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employee",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServicesEmployees_Services_ServicesId",
            ...
            migrationBuilder.InsertData(
                table: "Role",
                columns: new[] { "Id", "CreatedBy", "CreatedDate", "IsDeleted", "ModificationBy", "ModificationDate", "Name" },
                values: new object[,]
                {
                    { 1, null, null, false, null, null, "Admin" },
                    { 2, null, null, false, null, null, "Barber" },
                    { 3, null, null, false, null, null, "Employee" },
                    { 4, null, null, false, null, null, "Client" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicesEmployees_ServicesId",
                table: "ServicesEmployees",
                column: "ServicesId");
